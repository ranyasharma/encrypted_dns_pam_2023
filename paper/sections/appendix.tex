...
\includegraphics[width=\textwidth]{poah_NA}
    \caption{U.S. Home Networks (Local)}
\end{subfigure}
%
\begin{subfigure}[b]{0.4\textwidth}
\includegraphics[width=\textwidth]{ohio_NA}
    \caption{Ohio EC2 (Local).}
\end{subfigure}
%
\hfill \\
\begin{subfigure}[b]{0.4\textwidth}
\includegraphics[width=\textwidth]{frankfurt_NA}
    \caption{Frankfurt EC2.}
\end{subfigure}
%
\begin{subfigure}[b]{0.4\textwidth}
\includegraphics[width=\textwidth]{seoul_NA}
\caption{Seoul EC2.}
\end{subfigure}
...
%
\begin{subfigure}[b]{0.4\textwidth}
\includegraphics[width=\textwidth]{poah_europe}
\caption{U.S. Home Networks.}
\end{subfigure}
%
\begin{subfigure}[b]{0.4\textwidth}
\includegraphics[width=\textwidth]{ohio_eur}
\caption{Ohio EC2.}
\end{subfigure}
%
\hfill \\
\begin{subfigure}[b]{0.4\textwidth}
\includegraphics[width=\textwidth]{frankfurt_eur}
    \caption{Frankfurt EC2 (Local).}
\end{subfigure}
%
\begin{subfigure}[b]{0.4\textwidth}
\includegraphics[width=\textwidth]{seoul_eur}
\caption{Seoul EC2.}
\end{subfigure}
\caption{The DNS response time and ICMP ping time distributions for
...
%
\begin{subfigure}[b]{0.4\textwidth}
\includegraphics[width=\textwidth]{poah_asia}
\caption{U.S. Home Networks}
\end{subfigure}
%
\begin{subfigure}[b]{0.4\textwidth}
\includegraphics[width=\textwidth]{ohio_asia}
\caption{Ohio EC2.}
\end{subfigure}
%
\hfill \\
\begin{subfigure}[b]{0.4\textwidth}
\includegraphics[width=\textwidth]{frankfurt_asia}
    \caption{Frankfurt EC2.}
\end{subfigure}
%
\begin{subfigure}[b]{0.4\textwidth}
\includegraphics[width=\textwidth]{seoul_asia}
