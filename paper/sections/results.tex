...
\includegraphics[width=0.32\columnwidth]{figures/poah_NA.pdf}}%
\hfill%
\subfigure[Ohio EC2 (Local).]{%
\includegraphics[width=0.32\columnwidth]{figures/ohio_NA.pdf}}%
\hfill%
\subfigure[Frankfurt EC2.]{%
\includegraphics[width=0.32\columnwidth]{figures/frankfurt_NA.pdf}}%
\hfill%
\subfigure[Seoul EC2.]{%
\includegraphics[width=0.32\columnwidth]{figures/seoul_NA.pdf}}%
...
\includegraphics[width=0.32\columnwidth]{figures/poah_europe.pdf}}%
\hfill%
\subfigure[Ohio EC2.]{%
\includegraphics[width=0.32\columnwidth]{figures/ohio_eur.pdf}}%
\hfill%
\subfigure[Frankfurt EC2 (Local).]{%
\includegraphics[width=0.32\columnwidth]{figures/frankfurt_eur.pdf}}%
\hfill%
\subfigure[Seoul EC2.]{%
\includegraphics[width=0.32\columnwidth]{figures/seoul_eur.pdf}}%
    \caption{The DNS response time and ICMP ping time distributions for
...
\begin{figure}[t!]
    \subfigure[Home Devices.]{%
\includegraphics[width=0.32\columnwidth]{figures/poah_asia.pdf}}%
\hfill%
\subfigure[Ohio EC2.]{%
\includegraphics[width=0.32\columnwidth]{figures/ohio_asia.pdf}}%
\hfill%
\subfigure[Frankfurt EC2.]{%
\includegraphics[width=0.32\columnwidth]{figures/frankfurt_asia.pdf}}%
\hfill%
\subfigure[Seoul EC2 (Local).]{%
\includegraphics[width=0.32\columnwidth]{figures/seoul_asia.pdf}}%
    \caption{The DNS response time and ICMP ping time distributions for
