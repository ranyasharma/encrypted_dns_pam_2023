...
It is likely that in many of these cases, the resolver itself was simply no longer
operational; additional longitudinal measurements could confirm this
hypothesis.  From the EC2 instances, we did not receive a response from 
following resolvers: chewbacca.meganerd.nl, odoh-target-noads.alekberg.net,
odoh-target-se.alekberg.net, odoh-target-noads-se.alekberg.net, odoh-target.alekberg.net.
 However, we only performed measurements at a single point
