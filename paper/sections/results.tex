...
\includegraphics[width=0.32\linewidth]{figures/poah_NA.png}}%
\hfill%
\subfigure[Ohio EC2 (Local).]{%
\includegraphics[width=0.32\linewidth]{figures/ohio_NA.png}}%
\hfill%
\subfigure[Frankfurt EC2.]{%
\includegraphics[width=0.32\linewidth]{figures/frankfurt_NA.png}}%
\hfill%
\subfigure[Seoul EC2.]{%
\includegraphics[width=0.32\linewidth]{figures/seoul_NA.png}}%
...
the maximum response time from a resolver was __~ms; from Frankfurt, the maximum response time from a resolver was 380~ms. 
...
\includegraphics[width=0.32\linewidth]{figures/poah_europe.png}}%
\hfill%
\subfigure[Ohio EC2.]{%
\includegraphics[width=0.32\linewidth]{figures/ohio_eur.png}}%
\hfill%
\subfigure[Frankfurt EC2 (Local).]{%
\includegraphics[width=0.32\linewidth]{figures/frankfurt_eur.png}}%
\hfill%
\subfigure[Seoul EC2.]{%
\includegraphics[width=0.32\linewidth]{figures/seoul_eur.png}}%
    \caption{The DNS response time and ICMP ping time distributions for
...
\begin{minipage}{1.35\textwidth}
    \subfigure[Home Devices.]{%
\includegraphics[width=0.32\linewidth]{figures/poah_asia.png}}%
\hfill%
\subfigure[Ohio EC2.]{%
