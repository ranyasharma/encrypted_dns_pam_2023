...
\begin{figure}[t!]
\includegraphics[width=\columnwidth]{ohio_NA.pdf}
\caption{The DNS response time and ICMP ping time distributions for
    ...
    and ICMP round-trip latency. Results for other vantage points are shown in
    Figures~\ref{fig:dns-us}--\ref{fig:dns-europe} in the Appendix.}
